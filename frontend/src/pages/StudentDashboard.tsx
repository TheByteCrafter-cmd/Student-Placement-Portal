...
import { StudentJobPortal } from '../components/StudentJobPortal';
    ...
    <div className="app-container" style={{ maxWidth: '1050px' }}>
      <div className="card">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div className="badge status-online">Phase 5 — Student Job Portal & Feed</div>
        ...
        {/* Tab Navigation */}
        <div style={{ display: 'flex', gap: '0.5rem', margin: '1.25rem 0 0.5rem 0', borderBottom: '1px solid var(--border)', paddingBottom: '0.5rem' }}>
          <button className={`btn-secondary ${activeTab === 'jobs' ? 'btn-primary' : ''}`} onClick={() => setActiveTab('jobs')}>
            💼 Placement Jobs Feed
          </button>
          <button className={`btn-secondary ${activeTab === 'profile' ? 'btn-primary' : ''}`} onClick={() => setActiveTab('profile')}>
            👤 My Profile & Resumes ({completionScore}%)
          </button>
        </div>

        {/* TAB 1: VERIFIED JOB FEED */}
        {activeTab === 'jobs' && <StudentJobPortal />}

        {/* TAB 2: MY PROFILE & RESUMES */}
        {activeTab === 'profile' && (
          <div>
