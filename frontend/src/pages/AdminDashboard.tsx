...
export const AdminDashboard: React.FC = () => {
  ...
  const testStudentEndpointAsAdmin = async () => {
    try {
  ...
  return (
    <div className="app-container">
      <div className="card">
        <div className="badge status-warning">Admin Authentication Active</div>
        <h2>Admin Moderation Dashboard Placeholder</h2>
        <p className="subtitle">Role-Based Access Control Verified for ADMIN</p>
        ...
        <div className="action-row" style={{ gap: '1rem', flexWrap: 'wrap' }}>
          <button className="btn-primary" onClick={testAdminEndpoint}>
            Test /api/admin/test (Allowed)
          </button>

          <button className="btn-secondary" onClick={testStudentEndpointAsAdmin}>
            Test /api/student/test (Expect 403 Forbidden)
          </button>
